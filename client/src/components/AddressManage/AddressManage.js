...
const AddressManage = () => {
    ...
    return (
       ...
       Add address modal             >
                    ...
                    <Typography variant="body1" color="textSecondary" style={{ textAlign: 'center', padding: '20px' }}>No addresses found. Please add a shipping address.</Typography>
                )}
            ...
            </Dialog>{/* Delete address confirmation modal */}<Dialog open={showDeleteConfirmModal} onClose={() => setShowDeleteConfirmModal(false)} maxWidth="xs" fullWidth>

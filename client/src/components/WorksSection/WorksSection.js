                            ...
                            <div className="about-feature-content">
                                ...
                                <div className="box-items-area mt-3 mt-md-0">
                                    ...
                                    <div className="box-item active wow fadeInUp" data-wow-delay=".3s">
                                        ...
                                        <p>Eco-friendly water-based ink, non-irritating – suitable for sensitive skin and children.</p>
                                    </div>
                                    <div className="box-item wow fadeInUp" data-wow-delay=".3s">
                                        <h5>🧼 Easy to Wash, No Fading</h5>
                                        <p>No hand washing required. The printed design remains sharp even after machine washing or light tumble drying.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
